        ...
        {/* <div className="gaming-card p-4 sm:p-6 m-1 rounded-lg">
          ...
          {games.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <p className="text-base sm:text-lg mb-2">No games available</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 sm:gap-3">
              {games.map((game) => (
                <div key={game.id || game._id} className="w-full h-18 sm:h-18 md:h-20 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg flex items-center justify-center overflow-hidden cursor-pointer hover:shadow-md transition-all" onClick={() => {
