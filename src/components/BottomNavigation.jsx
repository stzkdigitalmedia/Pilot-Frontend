...
const BottomNavigation = ({ activePage }) => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#3f3f3f] max-w-[850px] mx-auto rounded-t-2xl shadow-lg z-50">
        <div className="flex items-center justify-around !!py-2 px-4 w-full max-w-[850px] mx-auto">
          {/* Home */}
          <button 
            onClick={() => navigate('/user-dashboard')}
            className={`flex flex-col items-center py-2 px-2 sm:px-3 transition-colors flex-1 ${
              activePage === 'home' ? 'text-[#197fed]' : 'text-white hover:text-[#197fed]'
            }`}
          >
          ...
          <button 
            ...
            className={`flex flex-col items-center py-2 px-2 sm:px-3 transition-colors flex-1 ${
              activePage === 'ids' ? 'text-[#197fed]' : 'text-white hover:text-[#197fed]'
            }`}
          >
            <svg className="w-5 h-5 sm:w-6 sm:h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            className={`flex flex-col items-center py-2 px-2 sm:px-3 transition-colors flex-1 ${
              activePage === 'passbook' ? 'text-[#197fed]' : 'text-white hover:text-[#197fed]'
            }`}
          >
            <svg className="w-5 h-5 sm:w-6 sm:h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
